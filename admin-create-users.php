...
<div class="controls">
<input type="date"    name="dob"  placeholder="Enter Product Comapny Name" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="number"    name="age"  placeholder="Enter Product Name" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="district"  placeholder="Enter Product Name" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="city"  placeholder="Enter Product Name" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="area"  placeholder="Enter Product Name" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="address"  placeholder="Enter Product Name" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="number"    name="pnumber"  placeholder="Enter Product Price" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="number"    name="snumber"  placeholder="Enter Product Price" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="password"    name="password"  placeholder="Enter Product Price" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="password"    name="password_confirm"  placeholder="Enter Product Price" class="span8 tip" required>
</div>
</div>
