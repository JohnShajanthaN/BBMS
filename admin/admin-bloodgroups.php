								...
								<table cellpadding="0" cellspacing="0" border="0" class="table-bordered" width="75%" align="center">
									...
									<thead>
										...
										<tr>
											...
											<th> <center> Number Of Members </center></th>
									...
									<td>
									<?php $sql1 = mysqli_query($con,"SELECT * from members_info where bloodtype='A+'");?>
									<h3 align="center"> <?php $rowcount=mysqli_num_rows($sql1);   printf("%d  \n",$rowcount); ?> </h3>
									</td>
									<td>
									...
									<td>
									<?php $sql1 = mysqli_query($con,"SELECT * from members_info where bloodtype='B+'");?>
									<h3 align="center"> <?php $rowcount=mysqli_num_rows($sql1);   printf("%d  \n",$rowcount); ?> </h3>
									</td>
									<td>
									<h3 align="center"> <?php $rowcount=mysqli_num_rows($sql);   printf("%d  \n",$rowcount); ?> </h3>
									...
									<td>
									<?php $sql1 = mysqli_query($con,"SELECT * from members_info where bloodtype='AB+'");?>
									<h3 align="center"> <?php $rowcount=mysqli_num_rows($sql1);   printf("%d  \n",$rowcount); ?> </h3>
									</td>
									<td>
									<h3 align="center"> <?php $rowcount=mysqli_num_rows($sql);   printf("%d  \n",$rowcount); ?> </h3>
									...
									<td>
									<?php $sql1 = mysqli_query($con,"SELECT * from members_info where bloodtype='O+'");?>
									<h3 align="center"> <?php $rowcount=mysqli_num_rows($sql1);   printf("%d  \n",$rowcount); ?> </h3>
									</td>
									<td>
									<h3 align="center"> <?php $rowcount=mysqli_num_rows($sql);   printf("%d  \n",$rowcount); ?> </h3>
