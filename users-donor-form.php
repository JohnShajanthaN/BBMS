...
if(isset($_POST['submit'])){
	...
	$donorscode = $nicnumber."".$bloodtype."".$phonenumber."".$referencenumber;
$query=mysqli_query($con,"insert into bloodbank_info(code,nicnumber,bloodtype,hospital,email,phonenumber,
address,status) 
values ('$donorscode','$nicnumber','$bloodtype',
'$hospital','$email','$phonenumber','$address','Donated')");

$query1=mysqli_query($con,"insert into blood_received_info(donorscode,referencenumber,nicnumber,bloodtype,hospital,email,phonenumber,
address) 
values ('$donorscode','$referencenumber','$nicnumber','$bloodtype',
...
if($query && $query1)
{
	...
	echo $donorscode = $_POST['donorscode'];
...
<div class="controls">
<input type="text"    name="referencenumber"   class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="hospital"  placeholder="Enter Product Name" class="span8 tip" required>
</div>
</div>
